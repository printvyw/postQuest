...
function moveToCenter()
    local centerX = LatestGameState.GameWidth / 2
    local centerY = LatestGameState.GameHeight / 2
    ao.send({ Target = Game, Action = "Move", Player = ao.id, X = centerX, Y = centerY })
end
